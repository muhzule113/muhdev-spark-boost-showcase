...
export const portfolio: PortfolioItem[] = [
  
  {
    ...
    category: "Web Dev",
    description: "E-commerce dengan Item-Based Collaborative Filtering untuk rekomendasi produk.",
    tech: ["Laravel", "MySQL", "Tailwind CSS", "Python"],
    image: "/portfolio/sinar-manis.png",
    details: "Toko online dengan sistem rekomendasi cerdas menggunakan Item-Based Collaborative Filtering. Fitur: katalog produk, keranjang, checkout, riwayat transaksi, rekomendasi personal, dan admin dashboard. Deploy di sinarmanis.muhzule.com.",
  },
  {
    id: "p3",
    title: "BOK Puskesmas Suppa — Input Jadwal Kegiatan",
    category: "Web Dev",
    description: "Web app manajemen jadwal kegiatan BOK untuk Puskesmas Suppa, Kabupaten Pinrang.",
    tech: ["Laravel 13", "Filament", "MySQL", "Docker"],
    image: "/portfolio/bok-puskesmas.png",
    details: "Sistem input jadwal kegiatan BOK (Bantuan Operasional Kesehatan) untuk Puskesmas Suppa. Fitur: kelola kegiatan, staff, tempat, tanggal, dengan master data management via Filament admin panel. Deploy di bok-pkmsuppa.web.id.",
  },
  {
    id: "p4",
  ...
  {
    id: "p5",
    title: "GenCV — AI CV & Cover Letter Generator",
    category: "Web Dev",
    description: "Generator CV ATS-friendly dengan AI assist, OCR import, PDF export, dan Midtrans payment.",
    tech: ["React 19", "Express", "PostgreSQL", "DeepSeek AI", "Midtrans"],
    image: "/portfolio/gencv.png",
    details: "Aplikasi generator CV & cover letter ATS-friendly. Fitur: multi-step form, live preview, AI summary & skill suggestions (DeepSeek), OCR import dari CV lama (Tesseract.js), PDF export, Google OAuth, token credits, Midtrans top-up, share via public link. Repo: muhzule113/GenCV.",
  },
  {
    id: "p6",
    title: "TokoRadar.Ai — Lead Generator SaaS",
    category: "Web Dev",
    description: "Lead generator internal untuk jasa UMKM dengan AI outreach & WhatsApp deep link.",
    tech: ["Next.js 14", "TypeScript", "InsForge", "PostgreSQL"],
    image: "/portfolio/tokoradar.png",
    details: "SaaS lead generator: import data dari Chrome extension (gmaps-scraper), dashboard analitik, filter lead, AI bulk message draft, dan deep link WhatsApp. Fitur: stat cards, bar chart, CSV export, pipeline status, interaction log. Repo: muhzule113/TokoRadar.",
  },
  {
    id: "p7",
    title: "Deteksi Buah — YOLO Object Detection API",
    category: "Tugas Kuliah",
    description: "API deteksi buah menggunakan YOLO object detection dengan Flask backend.",
    tech: ["Python", "Flask", "YOLO", "OpenCV", "Pillow"],
    image: "/portfolio/deteksi-buah.png",
    details: "API deteksi buah real-time menggunakan model YOLO yang dilatih custom. Endpoint POST /detect menerima image, return bounding box + label buah. Backend Flask dengan OpenCV preprocessing. Repo: muhzule113/DeteksiBuahFlask.",
  },
  {
    id: "p8",
    title: "muhdev — Portfolio Landing Page",
    category: "Web Dev",
    description: "Landing page jasa web development dengan neo-brutalist design, NeedMCP integration.",
    tech: ["React 19", "Vite", "Tailwind CSS", "shadcn/ui", "Vercel"],
    image: "/portfolio/muhdev-portfolio.png",
    details: "Website portfolio pribadi untuk jasa pembuatan website & bantuan tugas IT. Fitur: hero, layanan, pricing, portfolio filterable, testimoni carousel, FAQ accordion, estimasi harga interaktif, order form dengan Web3Forms + WhatsApp integration. Design: Slate Edge neo-brutalist (NeedMCP). Deploy di muhdevv.my.id.",
  },
];
