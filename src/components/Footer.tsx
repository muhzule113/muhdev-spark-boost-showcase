...
const Footer = () => (
  <footer className="border-t-2 border-foreground py-16" style={{ backgroundColor: 'var(--cream)' }}>
    <div className="container">
      <div className="grid gap-10 md:grid-cols-3">
        ...
        <div>
          ...
          <div className="flex flex-col gap-2">
            {navLinks.map((link) => (
              <Link key={link.href} to={link.href} className="text-sm font-bold text-foreground/80 hover:text-foreground transition-colors">
                {link.label}
              </Link>
            ))}
            <Link to="/legal" className="text-sm font-bold text-foreground/80 hover:text-foreground transition-colors">
              Kebijakan
            </Link>
          </div>
        </div>
        <div>
          ...
          <div className="flex flex-col gap-2 text-sm font-medium text-foreground/80">
            <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer" className="font-bold hover:text-foreground transition-colors">
              WhatsApp
            </a>
      ...
      <div className="mt-12 border-t-2 border-foreground pt-6 text-center text-xs font-extrabold text-foreground/80">
