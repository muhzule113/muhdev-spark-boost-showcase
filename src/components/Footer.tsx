    ...
    <div className="container">
      <div className="grid gap-10 md:grid-cols-3">
        <div>
          ...
          <p className="text-sm font-medium text-muted-foreground">{siteConfig.description}</p>
        </div>
        <div>
          ...
          <div className="flex flex-col gap-2">
            {navLinks.map((link) => (
              <Link key={link.href} to={link.href} className="text-sm font-bold text-muted-foreground hover:text-foreground transition-colors">
                {link.label}
              </Link>
            ))}
            <Link to="/legal" className="text-sm font-bold text-muted-foreground hover:text-foreground transition-colors">
              Kebijakan
            </Link>
          </div>
        </div>
      ...
      <div className="mt-12 border-t-2 border-foreground pt-6 text-center text-xs font-bold text-muted-foreground">
