  ...
  <section id="layanan" className="py-20">
    <div className="container">
      <ScrollReveal>
        ...
        <p className="mb-12 text-center font-medium text-foreground/80">Solusi lengkap untuk kebutuhan digital dan akademik Anda</p>
      </ScrollReveal>
        ...
        {services.map((s, i) => (
          <ScrollReveal key={s.id} delay={i * 0.1}>
            <div className="group h-full border-2 border-foreground bg-card p-8 shadow-brutal transition-all hover:shadow-brutal-sm hover:translate-x-[3px] hover:translate-y-[3px]">
              ...
              <p className="mb-4 text-sm font-medium text-foreground/80">{s.description}</p>
